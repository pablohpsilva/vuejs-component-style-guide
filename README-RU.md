...
* Документация предлагает разработчику высокоуровневое описание к. без необходимости вникать в его код. Это делать использование компонента более быстрым и простым
...
* Документация формализует API, показывает разработчикам какая часть функционала сохранять для обратной совместимости при модификации кода компонента
